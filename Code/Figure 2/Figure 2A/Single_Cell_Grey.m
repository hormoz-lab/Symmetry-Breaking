%% Grey Sphere (High-Res, Transparent Background, Minimal & Robust)
...
h = surf(ax, X, Y, Z, ...
    'FaceColor', [0.6 0.6 0.6], ...    % GREY (RGB)
    'FaceAlpha', 1, ...
    'EdgeColor', 'none', ...
...
exportgraphics(f, fullfile(output_path, 'GreySphere.png'), ...
    'BackgroundColor','none', 'ContentType','image', 'Resolution', 600);

fprintf('✅ Grey sphere saved to %s\n', fullfile(output_path, 'GreySphere.png'));