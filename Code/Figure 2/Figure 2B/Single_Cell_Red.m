%% Red Sphere (High-Res, Transparent Background, Minimal & Robust)
...
exportgraphics(f, fullfile(output_path, 'RedSphere.png'), ...
    'BackgroundColor','none', 'ContentType','image', 'Resolution', 600);

fprintf('✅ Red sphere saved to %s\n', fullfile(output_path, 'RedSphere.png'));