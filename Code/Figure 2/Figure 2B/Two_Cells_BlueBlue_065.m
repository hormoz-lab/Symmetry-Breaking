...
surf(ax, Xs + c1(1), Ys + c1(2), Zs + c1(3), 'FaceColor',[0 0 1], commonProps{:}); % Blue
surf(ax, Xs + c2(1), Ys + c2(2), Zs + c2(3), 'FaceColor',[0 0 1], commonProps{:}); % Blue
...
outfile = fullfile(output_path, 'BlueBlueCells_Squeezed_Yview_0.65.png');
