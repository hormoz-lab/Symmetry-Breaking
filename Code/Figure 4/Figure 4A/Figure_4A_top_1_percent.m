...
file_path     = '/n/data1/hms/sysbio/hormoz/users/suxuan/OUTPUT6_10_asymmetry_cluster_weighted_summary_confirm_101425_combined_ranked.csv';
out_dir       = '/home/suw469/codes/Gastruloid_Modeling/Modeling/Materials/Figures/Figure 4/Figure 4A';
if ~exist(out_dir, 'dir'), mkdir(out_dir); end

TOP_PERCENT   = 1;                                                         % 100 → use top 100% highest-asymmetry entries
