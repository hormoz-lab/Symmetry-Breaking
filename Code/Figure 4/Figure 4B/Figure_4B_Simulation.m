...
output_path               = '/home/suw469/codes/Gastruloid_Modeling/Modeling/Materials/Figures/Figure 4/Figure 4B';
...
video_root = fullfile(output_path, ...
             sprintf('Aii_%.3f_Aoo_%.3f_Aio_%.3f_BLii_%.3f_BLoo_%.3f_BLio_%.3f_BLoi_%.3f_D1_%d', ...
             Aii, Aoo, Aio, BLii, BLoo, BLio, BLoi, D1));
