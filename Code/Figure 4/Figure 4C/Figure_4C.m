...
input_path      = fullfile(parent_path, 'Figures/Figure 4/Figure 4B/Aii_0.775_Aoo_0.950_Aio_0.875_BLii_0.000_BLoo_0.135_BLio_0.000_BLoi_0.000');
output_path     = fullfile(parent_path, 'Figures/Figure 4/Figure 4C');
if ~exist(output_path,'dir'), mkdir(output_path); end
output_filename = 'Figure_4C';
OUTPUT          = 6:10;               
