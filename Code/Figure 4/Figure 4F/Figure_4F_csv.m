...
output_file = '/Users/linda0122/Desktop/Materials/Figures/Figure 4/Figure 4F/Figure_4F.csv';
...
%% Step 3: Build the complete asymmetry table across all non-negative beta_oo values
...
for beta_value = beta_values
    ...
    % Step 3.2.3: Store the asymmetry_avg for the specific betaL_oo
    col_name_avg = sprintf('asymmetry_avg_betaL_oo_%.3f', beta_value);                     % Create column name
    col_name_avg = strrep(col_name_avg, '.', '_'); 
    base_table.(col_name_avg) = compare_table.asymmetry_avg;                               % Append as new column
end
