...
parent_path               = '/n/data1/hms/sysbio/hormoz/users/suxuan/Materials/Codes/Virtual_Experiment/Experiment 3/Outer_12.5%_Red_12.5%_Red_Inner_75%_Blue';
noise_path                = '/n/data1/hms/sysbio/hormoz/users/suxuan/Materials/Codes/Virtual_Experiment/Experiment 3';

% Load noise
noise_filename            = fullfile(noise_path,'Noise_3000.mat');          % Path to noise file
load(noise_filename, 'Noise_3000');                                         % Loads a 1×SAMPLE cell array for movement noise
...
parfor Sample = 6:10
    ...
    input_file_path_P         = fullfile(sample_folder, 'WorkSpace_MatrixP_Expanded.csv');
    ...
    for t = Tmax*2 + dt : dt : Tmax*12
        ...
        noise_term               = kappaF * sqrt(dt) * Noise_3000{1, Sample}(:, :, round(t / dt_ini));
