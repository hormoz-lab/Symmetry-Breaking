...
parent_path               = '/n/data1/hms/sysbio/hormoz/users/suxuan/Materials/Codes/Virtual_Experiment/Experiment 3/Outer_12.5%_Red_Periphery_Inner_75%_Blue';
noise_path                = '/n/data1/hms/sysbio/hormoz/users/suxuan/Materials/Codes/Virtual_Experiment/Experiment 3';

% Load noise
noise_filename            = fullfile(noise_path,'Noise_p3000_t3000.mat');   % Path to noise file
load(noise_filename, 'Noise');                                              % Loads a 1×SAMPLE cell array for movement noise
...
video_root = fullfile(parent_path, 'Simulation_Time_500_3000_no_friction', ...
...
parfor Sample = 6:10
    ...
    input_file_path_P         = fullfile(sample_folder, 'WorkSpace_MatrixP_Pruned.csv');
    input_file_path_G         = fullfile(sample_folder, 'WorkSpace_MatrixG_Pruned.csv');
    ...
    for t = Tmax*2 + dt : dt : Tmax*12
        ...
        noise_term               = kappaF * sqrt(dt) * Noise{1, (Sample-5)}(1:num_cells, :, round(t / dt_ini));
