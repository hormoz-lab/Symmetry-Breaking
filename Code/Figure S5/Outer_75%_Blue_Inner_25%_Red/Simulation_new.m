...
parent_path               = '/n/data1/hms/sysbio/hormoz/users/suxuan/Materials/Codes/Virtual_Experiment/Experiment 4/Outer_75%_Blue_Inner_25%_Red';
...
parfor Sample = 6:10
    ...
    input_file_path_G         = fullfile(sample_folder, 'WorkSpace_MatrixG_Reversed.csv');
