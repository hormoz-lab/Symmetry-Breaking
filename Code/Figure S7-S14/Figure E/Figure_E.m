...
input_path      = fullfile(parent_path, 'Figures/Figure S7/Figure S7C/Aii_0.800_Aoo_0.750_Aio_0.800_BLii_0.150_BLoo_0.000_BLio_0.000_BLoi_0.000');
output_path     = fullfile(parent_path, 'Figures/Figure S7/Figure S7E');
if ~exist(output_path,'dir'), mkdir(output_path); end
output_filename = 'Figure_S7E';
OUTPUT          = 6:10;               

% Define physical parameters
r               = 1.0;              % cell radius used for "contact"
contact_thresh  = 2*r;              % two cells are connected if cell-cell distance <= contact_thresh
max_asymmetry_short = 0.8278;
...
% Step 3.4: Add a reference horizontal line at A = 0.8278
yline(max_asymmetry_short, '--', 'Color', [1 0.4 0.7], 'LineWidth', 1.8); 
